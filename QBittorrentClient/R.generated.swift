...
struct R: Rswift.Validatable {
  ...
  struct color {
    ...
    /// Color `barItemTint`.
    static let barItemTint = Rswift.ColorResource(bundle: R.hostingBundle, name: "barItemTint")
    /// Color `baseBgColor`.
    static let baseBgColor = Rswift.ColorResource(bundle: R.hostingBundle, name: "baseBgColor")
    /// Color `iconColor`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIColor(named: "barItemTint", bundle: ..., traitCollection: ...)`
    @available(tvOS 11.0, *)
    @available(iOS 11.0, *)
    static func barItemTint(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIColor? {
      return UIKit.UIColor(resource: R.color.barItemTint, compatibleWith: traitCollection)
    }
    #endif

    #if os(iOS) || os(tvOS)
    /// `UIColor(named: "baseBgColor", bundle: ..., traitCollection: ...)`
    @available(tvOS 11.0, *)
    @available(iOS 11.0, *)
    static func baseBgColor(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIColor? {
      return UIKit.UIColor(resource: R.color.baseBgColor, compatibleWith: traitCollection)
    }
    #endif
    ...
    /// `UIColor(named: "barItemTint", bundle: ..., traitCollection: ...)`
    @available(watchOSApplicationExtension 4.0, *)
    static func barItemTint(_: Void = ()) -> UIKit.UIColor? {
      return UIKit.UIColor(named: R.color.barItemTint.name)
    }
    #endif
    ...
    /// `UIColor(named: "baseBgColor", bundle: ..., traitCollection: ...)`
    @available(watchOSApplicationExtension 4.0, *)
    static func baseBgColor(_: Void = ()) -> UIKit.UIColor? {
      return UIKit.UIColor(named: R.color.baseBgColor.name)
    }
    #endif
    ...
    /// `UIColor(named: "tabBarBgColor", bundle: ..., traitCollection: ...)`
    @available(watchOSApplicationExtension 4.0, *)
    static func tabBarBgColor(_: Void = ()) -> UIKit.UIColor? {
      return UIKit.UIColor(named: R.color.tabBarBgColor.name)
    }
    #endif
